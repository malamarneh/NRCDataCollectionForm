            ...
            $.extend(abp.ajax, {
                ...
                showError: function (error) {
                    if (error.message === undefined) {
                        return abp.message.error("", GetTranslation("ErrorMessageDefault"));
                    }
                    if (error.message.indexOf(GetTranslation("CheckInput")) >= 0 || abp.ng.http.defaultError.message.indexOf(GetTranslation("CheckInput")) >= 0) {
                        if (error.details) {
                            setTimeout(function () {
                                return abp.message.error((error.message || abp.ng.http.defaultError.message), GetTranslation("InvalidData"));
                            }, 1000)
                        ...
                        if (error.details) {
                            setTimeout(function () {
                                return abp.message.error((error.message || abp.ng.http.defaultError.message) + error.details + GetTranslation("SupportMessage").replace("IT_Helpdesk", "<a href='mailto: " + $('#supportEmail').val() + "'>IT_Helpdesk</a>") + "<br/>" + GetTranslation("SupportMessageInstructions"), GetTranslation("ErrorMessageDefault"));
                            }, 1000)
                        } else {
                            setTimeout(function () {
                                return abp.message.error((error.message || abp.ng.http.defaultError.message) + GetTranslation("SupportMessage").replace("IT_Helpdesk", "<a href='mailto: " + $('#supportEmail').val() + "'>IT_Helpdesk</a>") + "<br/>" + GetTranslation("SupportMessageInstructions"), GetTranslation("ErrorMessageDefault"));
                            }, 1000)
                        }
                    }
                },
